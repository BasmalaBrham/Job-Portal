                ...
                <div class="card shadow border-0 p-5">
                    ...
                    <form method="post" action="{{route('account.processRegistration')}}" name="registrationForm" id="registrationForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Email" value="{{old('name')}}">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="confirm_password" id="confirm_password" value="{{old('confirm_password')}}" class="form-control @error('confirm_password') is-invalid @enderror" placeholder="please confirm Password">
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status == false) {
                ...
                // التحقق من أخطاء البريد الإلكتروني
                if (errors.email) {
                ...
                // التحقق من أخطاء تأكيد كلمة المرور
